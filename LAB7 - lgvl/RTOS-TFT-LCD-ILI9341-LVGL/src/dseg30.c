...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 0, .box_w = 3, .box_h = 4, .ofs_x = -2, .ofs_y = 0},
    {.bitmap_index = 2, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 74, .adv_w = 392, .box_w = 3, .box_h = 29, .ofs_x = 19, .ofs_y = 1},
    {.bitmap_index = 85, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 157, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 229, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 301, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 373, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 445, .adv_w = 392, .box_w = 19, .box_h = 29, .ofs_x = 3, .ofs_y = 1},
    {.bitmap_index = 514, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 586, .adv_w = 392, .box_w = 19, .box_h = 30, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 658, .adv_w = 96, .box_w = 3, .box_h = 16, .ofs_x = 1, .ofs_y = 7}
};
